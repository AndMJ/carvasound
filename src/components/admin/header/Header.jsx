...
const Header = ({handleDrawerToggle}) => {
    ...
    return (
        <>
            <Stack component={"nav"} direction={"row"} alignItems={"center"} justifyContent={"space-between"} className={"navbar navbar-expand bg-white mb-4 shadow"}>
                <IconButton
                    color="primary"
                ...
                <Stack sx={{ mr: 2 }} spacing={1} direction={"row"} alignItems={"center"} justifyContent={"flex-end"}>
            ...
            {/*<nav className="navbar navbar-expand bg-white mb-4 shadow"> /!*topbar*!/*/}
